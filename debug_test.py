...
r1 = client.post("/api/v1/bci/command", json={"command": "push"})
print("R1:", r1.json())
r2 = client.post("/api/v1/bci/command", json={"command": "push"})
print("R2:", r2.json())
r3 = client.post("/api/v1/bci/command", json={"command": "reset"})
print("R3:", r3.json())
