...
class CortexBridge:
    def __init__(
        ...
        self.client_id = (client_id or os.getenv("CORTEX_CLIENT_ID", "BGgqY14NxNaIg4CS1A8DTXpTIxkbjk0k1mSKuC9Q")).strip()
        self.client_secret = (client_secret or os.getenv("CORTEX_CLIENT_SECRET", "ifshe9t3pYT549IpTrGo880m7Nt3gmhEwJpc4wSgb8hGa6aWlJRnJBrEB0DFGVq01Ok7E6lIf7uDEdO3G8dWtjTaTyfhw8yFgbHv2567PnMrR2wXOT6NP5updF4sgIGv")).strip()
