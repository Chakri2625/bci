...
class EcosystemOrchestrator:
    async def process_command(self, command: Union[str, list], session: str = "default", confidence: float = 1.0, source: str = "unknown", device_id: str = None):
        ...
        if resolution["type"] == "transition":
            ...
            lifecycle_tracker.track_success(command_id, result={"type": "transition", "domain": resolution["domain"], "app": resolution["app"]})
